...
sys.modules["modules.standard.hierarchical_module"] = sys.modules.get(
    "hierarchical_module", HierarchicalModule
)
sys.modules["modules.hierarchical_module"] = sys.modules.get(
    "hierarchical_module", HierarchicalModule
)
sys.modules["hierarchical_module"] = sys.modules.get(
    "hierarchical_module", HierarchicalModule
)
